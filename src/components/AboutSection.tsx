      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              <p className="text-muted-foreground leading-relaxed mb-6 dark:text-white/60">
                I'm a <span className="text-foreground font-semibold dark:text-white">Project Associate at CDAC Chennai</span>, currently working on a critical Government of India / Indian Navy project. With over 2 years of experience, I specialize in building scalable backend systems using Spring Boot and Microservices architecture.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6 dark:text-white/60">
              ...
              <p className="text-muted-foreground leading-relaxed dark:text-white/60">
            ...
            <div className="grid gap-4">
              {highlights.map((h, i) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-primary/10 dark:bg-white/10">
                    <h.icon className="w-6 h-6 text-neon-cyan dark:text-white" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground dark:text-white">{h.label}</h3>
                    <p className="text-sm text-muted-foreground dark:text-white/40">{h.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
